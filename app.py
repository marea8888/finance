...
def ricavi_chart(df):
    ...
    colore_retail = "#2563EB"        # blu
    colore_wholesale = "#F59E0B"     # arancione
    ...
    delta_padding = max(abs(delta_min), abs(delta_max), 100) * 0.35
